...
const JOB_PHASE_LABELS: Record<string, string> = {
  ...
  mapping_structure: "正在准备 Codex 资料编目",
  classifying_sections: "Codex 正在拆分全书篇幅",
  extracting_toc: "Codex 正在提取完整目录",
  anchoring_chapters: "多个 Codex 正在并行绑定章节正文",
  merging_workers: "正在合并 Codex 处理结果",
  validating_index: "正在校验目录与正文索引",
