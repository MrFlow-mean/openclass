...
export function BranchMergeReviewCard({
  ...
  const sourceBranchLabel = txt.studio.branchDisplayName(preview.source_branch);
  const targetBranchLabel = txt.studio.branchDisplayName(preview.target_branch);
  return (
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <h5 className="mt-1 truncate text-sm font-semibold text-gray-950">
            {sourceBranchLabel} → {targetBranchLabel}
          </h5>
        </div>
        <button
          type="button"
