    ...
    <div className="space-y-8">
      <div>
        ...
        {visibleResources.length ? (
          ...
          <div
            aria-label="资料区预留位"
            className="mt-4 flex min-h-40 items-center justify-center rounded-lg border border-dashed border-gray-200 bg-white px-4 text-center text-xs text-gray-400"
          >
            当前课还没有资料。
          </div>
        )}
