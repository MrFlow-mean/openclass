...
import { useBoardDraft } from "@/components/course-studio/use-board-draft";
import { useCourseWorkspace, type CoursePackageApplyOptions } from "@/components/course-studio/use-course-workspace";
import { useLessonChatAgent } from "@/components/course-studio/use-lesson-chat-agent";
import { useLessonHistory } from "@/components/course-studio/use-lesson-history";
import { useModelCatalog } from "@/components/course-studio/use-model-catalog";
import { useRealtimeVoice } from "@/components/course-studio/use-realtime-voice";
import { useWorkspaceActions } from "@/components/course-studio/use-workspace-actions";
