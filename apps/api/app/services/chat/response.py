...
def _response(
    *,
    ...
    resource_generation_plan: list[ResourceBoardProposal] | None = None,
    ...
    return ChatResponse(
        ...
        resource_evidence_bundle=resource_evidence_bundle,
        resource_board_proposal=resource_board_proposal,
        resource_generation_plan=resource_generation_plan or [],
