...
class BoardTaskRequirementsBuilder(Protocol):
    def __call__(
        self,
        *,
...
class BoardTaskReadyCheckpointPersister(Protocol):
    def __call__(
        self,
        *,
        user_id: str,
...
class RecentBoardEditFocusResolver(Protocol):
    def __call__(
        self,
        *,
        lesson: Lesson,
...
class BoardTaskEditHandlerDependencies:
    requirements_from_board_task: BoardTaskRequirementsBuilder
    persist_ready_checkpoint: BoardTaskReadyCheckpointPersister
    ...
    recent_board_edit_focus_for_commit: RecentBoardEditFocusResolver
...
def handle_board_task_edit(
    *,
    ...
    deps: BoardTaskEditHandlerDependencies,
) -> ChatResponse:
