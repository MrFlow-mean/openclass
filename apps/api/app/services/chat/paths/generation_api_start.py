    ...
    *,
    ...
    if not edit_outcome.changed:
        ...
        record_workflow_step(
            ...
            run_id=failed_stamp.run_id if failed_stamp else None,
            version_id=failed_stamp.version_id if failed_stamp else None,
        )
    ...
    record_workflow_step(
        ...
        decision="committed",
        run_id=consumed_stamp.run_id if consumed_stamp else None,
        version_id=consumed_stamp.version_id if consumed_stamp else None,
