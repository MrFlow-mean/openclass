    ...
    def generate_teacher_chat(
        ...
        *,
        ...
        system_prompt = (
            ...
            "有帮助的你问我答交流。\n"
            "规则：\n"
            "1. 只讲解当前板书中已经存在的内容；如果用户问的内容不在板书里，明确说明板书里暂时没有这部分，"
            "不要展开讲解，也不要用通用知识补全。\n"
            "2. 只根据用户问题、当前课程上下文、板书摘要、引用选区、资料摘要和最近对话回答；"
            "资料和对话只能帮助理解板书内容，不能扩展出板书没有的讲解。\n"
            ...
            "6. 每次最多追问一个主问题；可以给 2-3 个可选回答方向，但不要像机械问卷或客服套话。\n"
