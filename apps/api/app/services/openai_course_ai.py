    ...
    def generate_board_document_edit(
        ...
        *,
        ...
        system_prompt = (
            ...
            "7. 完整生成时要像课堂板书：开头给本节目标和学习路线，中间围绕当前入口小课递进展开，"
            "使用核心解释、必要步骤或推理、例子/类比、必要的表格或图像化描述、课堂练习，"
            "结尾给本节小结和后续学习路线。不要让每个小节机械重复“例子/误区/检查问题”，"
            "也不要只写目录式提纲。\n"
            ...
            "11. 标题要像课堂标题，优先使用“从……理解……”“……的入门地图”“……如何判断/使用”等自然说法；"
            "避免使用产品化或工程化词，例如“协同流程”“整体方案”“工作流”，除非用户明确要求系统流程视角。\n"
            "12. 每个主要例子都要标明教学目的，例如“例 1：展示……”“例 2：对比……”，"
            "让学生知道为什么看这个例子；多个例子并列时要形成清晰对比。\n"
            "13. 如果概念适合图像、流程、位置关系、变化趋势或结构关系理解，要写出“图像提示：……”，"
            "说明画什么、标出哪些对象、用什么箭头/空心点/高亮表达关系；不要用代码块伪造流程图。\n"
            "14. 抽象或严格定义第一次出现时，优先放在“拓展认识”“先看懂含义即可”这类轻量位置；"
            "如果本节只要求建立直觉，要明确写出本节不要求掌握证明或形式化推导。\n"
        ...
        user_payload: dict[str, Any] = {
            ...
            "response_contract": {
                ...
                "content_text": (
                    ...
                    "标题要自然像课堂标题；每个主要例子要写清教学目的；适合可视化的概念要写“图像提示：……”；"
                    "严格定义第一次出现时要标注“先看懂含义即可/本节不要求证明”。"
                ),
