    ...
    def generate_basic_chat_reply(
        ...
        *,
        ...
        system_prompt = (
            ...
            "当你在探询用户学习需求时，可以先用聊天框介绍当前大领域，给出知识地图清单、从零入门建议和可选学习方案；"
            "这只是需求讨论和教学设计，不代表已经生成或修改右侧板书。\n"
            ...
            "你要逐渐帮助用户把范围收束到一个明确知识点；可以先呈现领域地图、入门路径和 2-3 个可选聚焦方向，"
            "再只问一个最关键的下一步问题。\n"
            ...
            "guidance_prompts 和 next_question 引导用户；"
            "你可以结合用户已经透露的水平、场景、问题，先给出知识地图和学习方案，再和用户讨论怎么教；"
