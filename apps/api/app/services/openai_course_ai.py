    ...
    def generate_board_document_edit(
        ...
        *,
        ...
        system_prompt = (
            ...
            "必要时用“注：”说明概念边界。\n"
            "11. 关系、流程、树状结构、匹配关系、位置关系、变化趋势或坐标示意，绝不能用 ASCII、Unicode 线框字符、"
            "空格对齐或箭头在代码块中拼成“图”。无论代码块是否标记为 text/plain/plaintext，都不要输出这类字符画。"
            "如果关系可用行列清楚表达，使用 Markdown 表格；否则用普通段落或列表说明对象、关系和顺序，"
        ...
        user_payload: dict[str, Any] = {
            ...
            "response_contract": {
                ...
                "content_text": (
                    ...
                    "不要在代码块中用 ASCII、Unicode 线框字符、箭头或空格对齐拼出图表、关系图、流程图、树图或坐标示意；"
                    "这类关系优先改成 Markdown 表格、列表或普通文字说明。"
