...
from app.services.chat.paths.board_task_write import (
...
def _board_task_write_deps() -> BoardTaskWriteDependencies:
...
def _confirmed_resource_generation_deps() -> ConfirmedResourceGenerationDependencies:
