    ...
    def process(
        ...
        *,
        ...
        try:
            ...
            adapter, resolved = media_adapter_registry.resolve(
                record.source_uri,
                title=record.title,
                use_browser_authorization=bool(
                    record.metadata.get("youtube_browser_authorization")
                ),
            )
            _emit(
                progress,
            ...
            if (
                ...
                if segments:
                    ...
                    transcription = transcription_provider_for(transcription_model).transcribe(
                        audio_files,
            ...
            raise MediaIngestionPipelineError(
                str(exc),
                code=str(getattr(exc, "code", "media_processing_failed")),
