...
def _load_resource_target(lesson_id: str | None):
...
def upload_resource(file: UploadFile = File(...), lesson_id: str | None = Form(None)) -> CoursePackageView:
    workspace, package, response_lesson_id = _load_resource_target(lesson_id)
...
def delete_resource(resource_id: str, lesson_id: str | None = None) -> CoursePackageView:
    workspace, package, response_lesson_id = _load_resource_target(lesson_id)
