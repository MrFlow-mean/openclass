...
@pytest.mark.xfail(
    reason="Confirmed-resource generation does not yet emit PR #95 ready-generation trace nodes.",
...
@pytest.mark.xfail(
    reason="Confirmed-resource generation failure does not yet emit PR #95 ready-generation trace nodes.",
    raises=AssertionError,
    strict=True,
)
