...
def test_handler_success_forced_freezes_before_generate_commits_consumes_saves_then_assembles(
    ...
    def _latest_learning_clarification(*args, **kwargs):
...
def test_handler_rejects_non_start_generation_action(tmp_path: Path) -> None:
    ...
    assert clarification.ready_for_board is False
